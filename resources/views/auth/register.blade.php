...
@section('content')
		<div class="bg-white rounded-lg flex justify-center flex-col items-center py-4 w-4/5 lg:w-1/2">
			...
			<form action="{{ route('register') }}" method="POST" class="flex justify-center flex-col w-4/5 md:w-1/2 my-4 my-4">
				@csrf
				<div class="mb-4">
			...
			<a href="{{route('login')}}" class="w-4/5 md:w-1/2">
				<button class="bg-white text-gray-400 border-2 mt-3 border-gray-400 py-1 rounded-md font-medium w-full">Уже есть аккаунт? <span class="text-purple-600">Войти</span></button>
			</a>
		</div>
@endsection